...
application.controller('NotebookController', function($scope, $location, $routeParams, Elements, appConfig, $modal,
    ...
    $scope.delete = function() {
      ...
      alertService.deleteConfirm(
          "Est� a punto de eliminar el cuaderno \"" +
          notebook.name + "\". Perder� todo el contenido, incluyendo p�ginas.\n\n" +
          "Para confirmar que esto no es un error, escriba el nombre del cuaderno a continuaci�n:",
          notebook.name)
          .then(function() {
